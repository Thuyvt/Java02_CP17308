...
public class StudentManagement extends javax.swing.JFrame {
    ...
    private void getComboBoxClassName() {
        ...
        // B3: Set gia tri Model cho cboClassName
    ...
    private void getDataTable() {
        ...
        std1.setStudentNo("PH172639");
        std1.setStudentName("Vu Thi Thuy");
        std1.setClassName("CP17310");
        std1.setFinalGrade(7);
        std1.setStatus(true);
        
        Student std2 = new Student();
        std2.setStudentNo("PH172225");
        std2.setStudentName("Nguyen Van Luong");
        ...
        // C2:
        listStudent.add(new Student("PH129381", 
                "Tran Huu Tho", "Nam", "CP17225", 4, false));
        for (Student std : listStudent) {
            tableModel.addRow(new Object[] { std.getStudentNo(), std.getStudentName(),
            std.getGender(), std.getClassName(), std.getFinalGrade(), std.isStatus()});
        }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(tpnManageStudent, javax.swing.GroupLayout.DEFAULT_SIZE, 534, Short.MAX_VALUE))
        );
    ...
    private Student getValueInput() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Format final grade not correct please try again");
        } catch (NullPointerException ex) {
            JOptionPane.showMessageDialog(this, "Format final grade can not be null please try again");
        } finally {
           JOptionPane.showMessageDialog(this, "FINALLY BLOCK");
        }
...
//        }
        ...
        if (tableModel.getValueAt(selectedRowIndex, 5) != null
            && tableModel.getValueAt(selectedRowIndex, 5).toString().equals("true")) {
            chkStatus.setSelected(true);
        } else {
            chkStatus.setSelected(false);
        }
